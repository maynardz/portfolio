...
const GraphicDesign = props => {
  ...
  // Render the grid
  return (
    <div className={styles.gd_container}>
      <h1 style={ props.theme === 'light' ? {color: '#222', fontFamily: 'rejova', margin: 0, } : props.theme === 'dark' ? {color: 'whitesmoke', fontFamily: 'rejova', margin: 0, } : {} }>Graphic Design</h1>
